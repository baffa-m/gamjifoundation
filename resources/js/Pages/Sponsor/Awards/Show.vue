...
import { 
    ArrowLeft, Award, Calendar, DollarSign, Users, Edit, 
    CheckCircle, Clock, XCircle, AlertCircle, Building2, Eye, Mail
        ...
        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
            <div>
                <div class="flex items-center gap-3 mb-2">
                    <Badge :variant="statusColors[award.status]" class="flex items-center gap-1">
                        {{ award.status }}
                    </Badge>
        ...
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div :class="['p-8 rounded-2xl', isDark ? 'bg-slate-800/50 border border-slate-700' : 'bg-white border border-slate-200 shadow-sm']">
                    <h2 :class="['text-lg font-semibold mb-4', isDark ? 'text-white' : 'text-slate-900']">
                        Description
                    </h2>
